...
public class PostgreSQLConnection extends AbstractDBConnection implements
		DBConnection {
	...
	public DataRowSet queryForRs(String statement, String sortExp,
		...
		buffer.append(" limit " + String.valueOf(pageSize) + " offset "
				+ String.valueOf(beginindex));
	...
	public List<ColumnBean> getColumns(String uid, String tableName)
		...
		String statement = "select t.column_comment ,t.column_name,case COLUMN_KEY "
				...
				+ " COALESCE(COALESCE(t.CHARACTER_MAXIMUM_LENGTH,NUMERIC_PRECISION),10) AS  COL_LEN "
	...
	public BigDecimal getSequence(String seqName) {
		String statement = "select nextval('" + seqName + "')";
